...
namespace Red
{
	...
	namespace Audio
	{
		...
		public:
			...
			void BlitBufferResampled ( AudioBuffer & Source, ResampleMode Mode, uint32_t Channel, uint32_t SampleCount, uint32_t SourceStartSample = 0, uint32_t TargetStartSample = 0, float SampleRatio = 1.0f, uint32_t TargetChannel = 0xFFFFFFFF );
			...
			void AddBufferResampled ( AudioBuffer & Source, ResampleMode Mode, uint32_t Channel, uint32_t SampleCount, uint32_t SourceStartSample = 0, uint32_t TargetStartSample = 0, uint32_t TargetChannel = 0xFFFFFFFF, float SampleRatio = 1.0f );
			
			void ClearBufferFloat ( uint32_t Channel, float Value = 0.0f );
			void ClearBufferInt ( uint32_t Channel, int64_t Value = 0 );
